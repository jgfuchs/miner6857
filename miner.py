...
def main():
    ...
    header = {
        ...
        u'difficulty': 32,
        u'version': 0,
        u'parentid': u'169740d5c4711f3cbbde6b9bfbbe8b3d236879d849d1c137660fce9e7884cae7',
        u'nonces': [0, 0, 0],
    ...
    while True:
        ...
        if r.status_code == 200:
            ...
            print "Server error: {}, {}".format(r.status_code, r.text)
            return
